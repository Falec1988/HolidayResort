...
namespace HolidayResort.Infrastructure.Migrations
{
    ...
    [Migration("20241016114007_editBookingToDb")]
    partial class editBookingToDb
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("HolidayResort.Domain.Entities.ApplicationUser", b =>
                {
            ...
            modelBuilder.Entity("HolidayResort.Domain.Entities.Booking", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("HolidayResort.Domain.Entities.Booking", b =>
                {
                    ...
                    b.HasOne("HolidayResort.Domain.Entities.ApplicationUser", "User")
                        .WithMany()
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("HolidayResort.Domain.Entities.ApplicationUser", null)
                        .WithMany()
                        .HasForeignKey("UserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
